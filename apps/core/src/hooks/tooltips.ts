...
export const registerTooltips = () => {
    window.Hooks.on("renderActorSheetV2", (_sheet: unknown, html: HTMLElement, actor: Actor5e, _token: unknown) => {
        ...
        html.querySelectorAll(".item").forEach((_element: Element) => {
            ...
            const tooltipElement = element.querySelector(".item-tooltip") as HTMLElement;
            ...
            tooltipElement.addEventListener("mouseenter", (e: MouseEvent) => tooltip.showNextTo(e, abstract));
