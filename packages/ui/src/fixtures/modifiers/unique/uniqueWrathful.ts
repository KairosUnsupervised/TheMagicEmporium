	...
	breakpoints: [
		{
			...
			flavor: {
				title: "Wrathful",
				description:
					"While below half health, your melee attacks deal an extra 1d4 fire damage.",
				disclaimer: null,
			},
			activeEffects: [],
			feats: [],
		},
		{
			...
			flavor: {
				...
				description:
					"While below half health, your melee attacks deal an extra 1d8 fire damage and cause the target to burn.",
				disclaimer:
					"Burning deals 1d4 fire damage at the start of each of the target's turns.",
			},
			activeEffects: [],
			feats: [],
		},
