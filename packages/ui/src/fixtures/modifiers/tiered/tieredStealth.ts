...
export const tieredStealthFixture = new TieredModifier({
    ...
    tiers: [
        {min: 1, flavor: {title: "Redacted I",  description: "Your Stealth skill increases by +2.", disclaimer: null}, activeEffects: [], feats: []},
        {min: 2, flavor: {title: "Redacted II", description: "Your Stealth skill increases by +4 and you leave no tracks.", disclaimer: null}, activeEffects: [], feats: []},
    ],
})
